          ...
          <div className="row">
            {
              post.map(ele =>
                <div className="col-lg-4">              
                  <div className="card p-" style={{backgroundImage: `url(${ele.profile})`, height:'500px', backgroundSize: "cover" , backgroundPosition:'center'}}>
                    <button className='btn bg-danger btn-close position-absolute' style={{right:'10px',top:"10px"}}></button>
